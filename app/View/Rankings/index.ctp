<div class="rankings index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('user_score'); ?></th>
			<th><?php echo $this->Paginator->sort('start_event'); ?></th>
			<th><?php echo $this->Paginator->sort('end_event'); ?></th>
			<th><?php echo $this->Paginator->sort('created'); ?></th>
			<th><?php echo $this->Paginator->sort('modifid'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($ranking['Ranking']['user_score']); ?>&nbsp;</td>
		<td><?php echo h($ranking['Ranking']['start_event']); ?>&nbsp;</td>
		<td><?php echo h($ranking['Ranking']['end_event']); ?>&nbsp;</td>
		<td><?php echo h($ranking['Ranking']['created']); ?>&nbsp;</td>
		<td><?php echo h($ranking['Ranking']['modifid']); ?>&nbsp;</td>
		<td class="actions">
